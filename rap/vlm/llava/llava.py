...
class LLaVA(BaseModel):
    ...
    def __init__(self,
                 ...
                 is_process_image=False, processed_image_path=None, max_step=200, bias_value=0.2, rag_model_path='openbmb/VisRAG-Ret', temperature=0.,
                 **kwargs):
        try:
            from llava.model.builder import load_pretrained_model
        ...
        kwargs_default = dict(do_sample=False, temperature=temperature, max_new_tokens=512, top_p=None, num_beams=1, use_cache=True) # noqa E501
        if temperature > 0:
